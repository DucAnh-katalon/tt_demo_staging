...
WebUI.takeScreenshot(reportLocation + '/TC2/Step 3-Click on link dockLayout2 - Navigate to page dock management interface.png')

"Step 4: Click on input startEditEmployee"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '.*/.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_dock_management_interface/input_startEditEmployee'))
...
TrueTestScripts.selectOptionByValue(findTestObject('AI-Generated/Page_dock_management_interface/select_selectedWorkingStatus'), select_selectedWorkingStatus)
...
// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_dock_management_interface/link_saveNewActions"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_dock_management_interface/link_saveNewActions', ['link_saveNewActions_internalText': link_saveNewActions_internalText, 'link_saveNewActions_nth': link_saveNewActions_nth]))
...
// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_dock_management_interface/button_editStartTime"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_dock_management_interface/button_editStartTime', ['button_editStartTime_actualStart': button_editStartTime_actualStart]))
...
// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_dock_management_interface/link_saveNewActions"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_dock_management_interface/link_saveNewActions', ['link_saveNewActions_internalText': link_saveNewActions_internalText_1, 'link_saveNewActions_nth': link_saveNewActions_nth_1]))
...
// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_dock_management_interface/link_saveNewActions"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_dock_management_interface/link_saveNewActions', ['link_saveNewActions_internalText': link_saveNewActions_internalText_2, 'link_saveNewActions_nth': link_saveNewActions_nth_2]))
...
// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_dock_management_interface/button_editStartTime"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_dock_management_interface/button_editStartTime', ['button_editStartTime_actualStart': button_editStartTime_actualStart_1]))
...
// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_dock_management_interface/link_saveNewActions"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_dock_management_interface/link_saveNewActions', ['link_saveNewActions_internalText': link_saveNewActions_internalText_3, 'link_saveNewActions_nth': link_saveNewActions_nth_3]))
...
WebUI.takeScreenshot(reportLocation + '/TC2/Step 12-Click on link close close2.png')
...
"Step 14: Click on link liveWorksheet -> Navigate to page 'live worksheet#*/*/*'"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '.*/.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_dock_management_interface/link_liveWorksheet'))

WebUI.takeScreenshot(reportLocation + '/TC2/Step 14-Click on link liveWorksheet - Navigate to page live worksheet.png')

"Step 15: Click on input addWork"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '.*/.*/.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_live_worksheet/input_addWork'))
...
TrueTestScripts.selectOptionByValue(findTestObject('AI-Generated/Page_live_worksheet/select_workType'), select_workType)
...
TrueTestScripts.selectOptionByValue(findTestObject('AI-Generated/Page_live_worksheet/select_workAssignmentTrailerNumber'), select_workAssignmentTrailerNumber)
...
TrueTestScripts.selectOptionByValue(findTestObject('AI-Generated/Page_live_worksheet/select_workAssignmentEmployeeId2'), select_workAssignmentEmployeeId2)
...
TrueTestScripts.selectOptionByValue(findTestObject('AI-Generated/Page_live_worksheet/select_workAssignmentDockLocId'), select_workAssignmentDockLocId)
...
WebUI.mouseOver(findTestObject('AI-Generated/Page_live_worksheet/link_dock'))
...
WebUI.enhancedClick(findTestObject('AI-Generated/Page_live_worksheet/link_liveWorksheet'))
...
"Step 25: Click on link dockLayout2 -> Navigate to page 'dock management interface#*/*'"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '.*/.*/.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_live_worksheet/link_dockLayout2'))

WebUI.takeScreenshot(reportLocation + '/TC2/Step 25-Click on link dockLayout2 - Navigate to page dock management interface.png')
...
"Step 27: Click on link liveWorksheet -> Navigate to page 'live worksheet#*/*/*'"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '.*/.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_dock_management_interface/link_liveWorksheet'))

WebUI.takeScreenshot(reportLocation + '/TC2/Step 27-Click on link liveWorksheet - Navigate to page live worksheet.png')

"Step 28: Click on input refresh"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '.*/.*/.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_live_worksheet/input_refresh'))
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC2-Edit Employee Status and Save Work Assignments_visual_checkpoint')
