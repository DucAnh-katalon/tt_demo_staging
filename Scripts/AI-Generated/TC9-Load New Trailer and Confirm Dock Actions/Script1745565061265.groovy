...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 3-Click on link dockLayout2 - Navigate to page dock management interface.png')

"Step 4: Click on link doorOptions (closeToBos2)"
...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 4-Click on link doorOptions closeToBos2.png')

"Step 5: Select option with input value from select newLoadToTerminal"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '.*/.*?/?(?:#.*)?(?:\\?.*)?$', true)

TrueTestScripts.selectOptionByValue(findTestObject('AI-Generated/Page_dock_management_interface/select_newLoadToTerminal'), select_newLoadToTerminal)
...
WebUI.enhancedClick(findTestObject('AI-Generated/Page_dock_management_interface/input_newTrailerNumber'))
...
WebUI.setText(findTestObject('AI-Generated/Page_dock_management_interface/input_newTrailerNumber'), input_newTrailerNumber)
...
WebUI.enhancedClick(findTestObject('AI-Generated/Page_dock_management_interface/input_saveTrailer'))
...
WebUI.enhancedClick(findTestObject('AI-Generated/Page_dock_management_interface/button_ok3'))
...
"Step 11: Click on link trek -> Navigate to page 'move shipment#*/*/*'"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '.*/.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_dock_management_interface/link_trek'))

WebUI.takeScreenshot(reportLocation + '/TC9/Step 11-Click on link trek - Navigate to page move shipment.png')
...
WebUI.setText(findTestObject('AI-Generated/Page_move_shipment/input_buffer'), input_buffer)
...
WebUI.enhancedClick(findTestObject('AI-Generated/Page_move_shipment/input_loadIt'))

WebUI.takeScreenshot(reportLocation + '/TC9/Step 15-Click on input loadIt.png')

"Step 16: Click on input override"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '.*/.*/.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_move_shipment/input_override'))

WebUI.takeScreenshot(reportLocation + '/TC9/Step 16-Click on input override.png')
...
WebUI.setText(findTestObject('AI-Generated/Page_move_shipment/input_buffer'), input_buffer_1)
...
"Step 20: Click on input override -> Navigate to page 'move confirmation#*/*/MoveConfirmation'"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '.*/.*/.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_move_shipment/input_override'))

WebUI.takeScreenshot(reportLocation + '/TC9/Step 20-Click on input override - Navigate to page move confirmationMoveConfirmation.png')

"Step 21: Click on input ok -> Navigate to page 'move shipment#*/*/*'"
...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 21-Click on input ok - Navigate to page move shipment.png')
...
WebUI.setText(findTestObject('AI-Generated/Page_move_shipment/input_buffer'), input_buffer_2)
...
"Step 26: Click on input override"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '.*/.*/.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_move_shipment/input_override'))

WebUI.takeScreenshot(reportLocation + '/TC9/Step 26-Click on input override.png')
...
WebUI.setText(findTestObject('AI-Generated/Page_move_shipment/input_buffer'), input_buffer_3)
...
"Step 30: Click on input override -> Navigate to page 'move confirmation#*/*/MoveConfirmation'"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '.*/.*/.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_move_shipment/input_override'))

WebUI.takeScreenshot(reportLocation + '/TC9/Step 30-Click on input override - Navigate to page move confirmationMoveConfirmation.png')

"Step 31: Click on input ok -> Navigate to page 'dock management interface#*/*'"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '.*/.*/MoveConfirmation?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_move_confirmation/input_ok'))

WebUI.takeScreenshot(reportLocation + '/TC9/Step 31-Click on input ok - Navigate to page dock management interface.png')
...
"Step 34: Click on link doorOptions (closeToBos)"
...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 34-Click on link doorOptions closeToBos.png')

"Step 35: Click on link close (close2) -> Navigate to page ''"
...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 35-Click on link close close2 - Navigate to page .png')

"Step 36: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC9-Load New Trailer and Confirm Dock Actions_visual_checkpoint')
