...
WebUI.takeScreenshot(reportLocation + '/TC5/Step 3-Click on link dockLayout2 - Navigate to page dock management interface.png')

"Step 4: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC5-Navigate to Dock Management Interface and Verify Page_visual_checkpoint')
