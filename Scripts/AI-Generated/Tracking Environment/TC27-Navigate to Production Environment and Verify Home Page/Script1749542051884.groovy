...
WebUI.takeScreenshot(reportLocation + '/TC27/Step 2-Click on link production - Navigate to page envproductionaut.png')
...
WebUI.takeScreenshot(reportLocation + '/TC27/Step 3-Click on button historyDetails - Navigate to page envproductionauthistory.png')
...
WebUI.takeScreenshot(reportLocation + '/TC27/Step 4-Click on link historyEntries history - Navigate to page envproductionauthistory.png')

"Step 5: Click on div collapsedFlows"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/env/production/aut/.*/history/.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Tracking Environment/Page_env_production_aut_history/div_collapsedFlows'))

WebUI.takeScreenshot(reportLocation + '/TC27/Step 5-Click on div collapsedFlows.png')

"Step 6: Click on div collapsedParams -> Navigate to page ''"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/env/production/aut/.*/history/.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Tracking Environment/Page_env_production_aut_history/div_collapsedParams'))

WebUI.takeScreenshot(reportLocation + '/TC27/Step 6-Click on div collapsedParams - Navigate to page .png')

"Step 7: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC27-Navigate to Production Environment and Verify Home Page_visual_checkpoint')
