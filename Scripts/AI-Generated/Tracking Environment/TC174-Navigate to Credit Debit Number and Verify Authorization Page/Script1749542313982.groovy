...
"Step 2: Click on link creditDebitNumber -> Navigate to page '/sessions/*/*/authorize'"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/sessions/selector?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Tracking Environment/Page_sessions_selector/link_creditDebitNumber'))

WebUI.takeScreenshot(reportLocation + '/TC174/Step 2-Click on link creditDebitNumber - Navigate to page sessionsauthorize.png')

"Step 3: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC174-Navigate to Credit Debit Number and Verify Authorization Page_visual_checkpoint')
