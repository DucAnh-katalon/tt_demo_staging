...
WebUI.takeScreenshot(reportLocation + '/TC6/Step 3-Click on link dockLayout2 - Navigate to page dock management interface.png')
...
"Step 5: Click on link trek -> Navigate to page 'move shipment#*/*/*'"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '.*/.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_dock_management_interface/link_trek'))

WebUI.takeScreenshot(reportLocation + '/TC6/Step 5-Click on link trek - Navigate to page move shipment.png')

"Step 6: Click on input buffer2"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '.*/.*/.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_move_shipment/input_buffer2'))
...
WebUI.setText(findTestObject('AI-Generated/Page_move_shipment/input_buffer2'), input_buffer2)
...
WebUI.enhancedClick(findTestObject('AI-Generated/Page_move_shipment/input_enter2'))
...
WebUI.enhancedClick(findTestObject('AI-Generated/Page_move_shipment/input_dockIt2'))

WebUI.takeScreenshot(reportLocation + '/TC6/Step 9-Click on input dockIt2.png')

"Step 10: Click on input enter2 -> Navigate to page 'move confirmation#*/*/MoveConfirmation'"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '.*/.*/.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_move_shipment/input_enter2'))

WebUI.takeScreenshot(reportLocation + '/TC6/Step 10-Click on input enter2 - Navigate to page move confirmationMoveConfirmation.png')

"Step 11: Click on input ok2 -> Navigate to page 'move shipment#*/*/*'"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '.*/.*/MoveConfirmation?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_move_confirmation/input_ok2'))

WebUI.takeScreenshot(reportLocation + '/TC6/Step 11-Click on input ok2 - Navigate to page move shipment.png')
...
WebUI.setText(findTestObject('AI-Generated/Page_move_shipment/input_buffer2'), input_buffer2_1)
...
"Step 16: Click on input enter2 -> Navigate to page 'move confirmation#*/*/MoveConfirmation'"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '.*/.*/.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_move_shipment/input_enter2'))

WebUI.takeScreenshot(reportLocation + '/TC6/Step 16-Click on input enter2 - Navigate to page move confirmationMoveConfirmation.png')

"Step 17: Click on input ok2 -> Navigate to page 'move shipment#*/*/*'"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '.*/.*/MoveConfirmation?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_move_confirmation/input_ok2'))

WebUI.takeScreenshot(reportLocation + '/TC6/Step 17-Click on input ok2 - Navigate to page move shipment.png')
...
WebUI.setText(findTestObject('AI-Generated/Page_move_shipment/input_buffer2'), input_buffer2_2)
...
"Step 22: Click on input enter2 -> Navigate to page 'move confirmation#*/*/MoveConfirmation'"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '.*/.*/.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_move_shipment/input_enter2'))

WebUI.takeScreenshot(reportLocation + '/TC6/Step 22-Click on input enter2 - Navigate to page move confirmationMoveConfirmation.png')

"Step 23: Click on input ok2 -> Navigate to page 'move shipment#*/*/*'"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '.*/.*/MoveConfirmation?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_move_confirmation/input_ok2'))

WebUI.takeScreenshot(reportLocation + '/TC6/Step 23-Click on input ok2 - Navigate to page move shipment.png')
...
WebUI.setText(findTestObject('AI-Generated/Page_move_shipment/input_buffer2'), input_buffer2_3)
...
"Step 28: Click on input enter2 -> Navigate to page 'move confirmation#*/*/MoveConfirmation'"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '.*/.*/.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_move_shipment/input_enter2'))

WebUI.takeScreenshot(reportLocation + '/TC6/Step 28-Click on input enter2 - Navigate to page move confirmationMoveConfirmation.png')

"Step 29: Click on input ok2 -> Navigate to page 'dock management interface#*/*'"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '.*/.*/MoveConfirmation?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_move_confirmation/input_ok2'))

WebUI.takeScreenshot(reportLocation + '/TC6/Step 29-Click on input ok2 - Navigate to page dock management interface.png')
...
"Step 32: Click on link doorOptions (doorNumber2)"
...
WebUI.takeScreenshot(reportLocation + '/TC6/Step 32-Click on link doorOptions doorNumber2.png')

"Step 33: Click on input sendToYard"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '.*/.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_dock_management_interface/input_sendToYard'))
...
"Step 35: Click on button okActions (ok2) -> Navigate to page ''"
...
WebUI.takeScreenshot(reportLocation + '/TC6/Step 35-Click on button okActions ok2 - Navigate to page .png')

"Step 36: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC6-Perform Multiple Dock Moves and Confirm Actions_visual_checkpoint')
