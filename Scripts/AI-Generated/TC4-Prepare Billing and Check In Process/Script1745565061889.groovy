...
WebUI.enhancedClick(findTestObject('AI-Generated/Page_billing_preparation/input_terminal'))
...
WebUI.setText(findTestObject('AI-Generated/Page_billing_preparation/input_terminal'), input_terminal)
...
WebUI.enhancedClick(findTestObject('AI-Generated/Page_billing_preparation/link_man'))

WebUI.takeScreenshot(reportLocation + '/TC4/Step 4-Click on link man.png')

"Step 5: Click on input driver"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_billing_preparation/input_driver'))

WebUI.takeScreenshot(reportLocation + '/TC4/Step 5-Click on input driver.png')

"Step 6: Enter input value in input driver"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.setText(findTestObject('AI-Generated/Page_billing_preparation/input_driver'), input_driver)

WebUI.takeScreenshot(reportLocation + '/TC4/Step 6-Enter input value in input driver.png')

"Step 7: Click on link name"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_billing_preparation/link_name'))
...
WebUI.enhancedClick(findTestObject('AI-Generated/Page_billing_preparation/input_trailer'))
...
WebUI.setText(findTestObject('AI-Generated/Page_billing_preparation/input_trailer'), input_trailer)
...
WebUI.enhancedClick(findTestObject('AI-Generated/Page_billing_preparation/input_door'))
...
WebUI.setText(findTestObject('AI-Generated/Page_billing_preparation/input_door'), input_door)
...
WebUI.enhancedClick(findTestObject('AI-Generated/Page_billing_preparation/input_checkIn'))
...
WebUI.setText(findTestObject('AI-Generated/Page_billing_preparation/input_checkIn'), input_checkIn)
...
WebUI.sendKeys(findTestObject('AI-Generated/Page_billing_preparation/input_checkIn'), Keys.chord(Keys.ENTER))
...
WebUI.setText(findTestObject('AI-Generated/Page_billing_preparation/input_checkIn'), input_checkIn_1)
...
WebUI.setText(findTestObject('AI-Generated/Page_billing_preparation/input_checkIn'), input_checkIn_2)
...
WebUI.setText(findTestObject('AI-Generated/Page_billing_preparation/input_checkIn'), input_checkIn_3)
...
WebUI.enhancedClick(findTestObject('AI-Generated/Page_billing_preparation/button_sendToDock'))
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC4-Prepare Billing and Check In Process_visual_checkpoint')
