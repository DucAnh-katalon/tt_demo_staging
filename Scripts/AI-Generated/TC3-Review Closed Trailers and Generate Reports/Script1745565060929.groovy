...
WebUI.enhancedClick(findTestObject('AI-Generated/Page_dock_management_interface/div_mainContainer'))
...
TrueTestScripts.selectOptionByValue(findTestObject('AI-Generated/Page_dock_management_interface/select_layoutSelectedTerminal'), select_layoutSelectedTerminal)
...
WebUI.mouseOver(findTestObject('AI-Generated/Page_dock_management_interface/link_linehaul'))
...
WebUI.enhancedClick(findTestObject('AI-Generated/Page_dock_management_interface/link_closedTrailersReview'))
...
"Step 10: Click on link proMovement -> Navigate to page 'pro movement reports#*/*/*'"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '.*/.*/.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_closed_trailers_review/link_proMovement'))

WebUI.takeScreenshot(reportLocation + '/TC3/Step 10-Click on link proMovement - Navigate to page pro movement reports.png')

"Step 11: Click on input proNumber"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '.*/.*/.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_pro_movement_reports/input_proNumber'))
...
"Step 13: Click on div proSearchForm2"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '.*/.*/.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_pro_movement_reports/div_proSearchForm2'))

WebUI.takeScreenshot(reportLocation + '/TC3/Step 13-Click on div proSearchForm2.png')
...
WebUI.enhancedClick(findTestObject('AI-Generated/Page_pro_movement_reports/td_osdExceptionPieces'))

WebUI.takeScreenshot(reportLocation + '/TC3/Step 17-Click on td osdExceptionPieces - Navigate to page .png')

"Step 18: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC3-Review Closed Trailers and Generate Reports_visual_checkpoint')
