...
WebUI.mouseOver(findTestObject('AI-Generated/Page_live_worksheet/link_pd'))

WebUI.takeScreenshot(reportLocation + '/TC12/Step 2-Hover over link pd.png')

"Step 3: Click on link changeCityRoutes -> Navigate to page 'project management#*/*/CreateNewRoute'"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '.*/.*/.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_live_worksheet/link_changeCityRoutes'))

WebUI.takeScreenshot(reportLocation + '/TC12/Step 3-Click on link changeCityRoutes - Navigate to page project managementCreateNewRoute.png')
...
// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_project_management/input_vehicleDetails"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_project_management/input_vehicleDetails', ['input_vehicleDetails_internalLabel': input_vehicleDetails_internalLabel]))
...
// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_project_management/input_vehicleDetails"
WebUI.setText(findTestObject('AI-Generated/Dynamic Objects/Page_project_management/input_vehicleDetails', ['input_vehicleDetails_internalLabel': input_vehicleDetails_internalLabel_1]), input_vehicleDetails)
...
// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_project_management/input_vehicleDetails"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_project_management/input_vehicleDetails', ['input_vehicleDetails_internalLabel': input_vehicleDetails_internalLabel_2]))
...
// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_project_management/input_vehicleDetails"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_project_management/input_vehicleDetails', ['input_vehicleDetails_internalLabel': input_vehicleDetails_internalLabel_3]))
...
// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_project_management/input_vehicleDetails"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_project_management/input_vehicleDetails', ['input_vehicleDetails_internalLabel': input_vehicleDetails_internalLabel_4]))
...
// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_project_management/input_vehicleDetails"
WebUI.setText(findTestObject('AI-Generated/Dynamic Objects/Page_project_management/input_vehicleDetails', ['input_vehicleDetails_internalLabel': input_vehicleDetails_internalLabel_5]), input_vehicleDetails_1)
...
WebUI.enhancedClick(findTestObject('AI-Generated/Page_project_management/input_proNumber'))
...
WebUI.setText(findTestObject('AI-Generated/Page_project_management/input_proNumber'), input_proNumber)
...
WebUI.enhancedClick(findTestObject('AI-Generated/Page_project_management/label_proSearch'))
...
WebUI.setText(findTestObject('AI-Generated/Page_project_management/input_proNumber'), input_proNumber_1)
...
WebUI.enhancedClick(findTestObject('AI-Generated/Page_project_management/input_submit'))
...
WebUI.enhancedClick(findTestObject('AI-Generated/Page_project_management/button_ok'))

WebUI.takeScreenshot(reportLocation + '/TC12/Step 19-Click on button ok.png')

"Step 20: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC12-Change City Routes and Manage Vehicle Details_visual_checkpoint')
