...
public class adminLogoutAndManageSiteRoles {
    
    private static def execute_functional_method(Map data) {
        
        "Step 1: Click on button siteServiceRoles"
        ...
        WebUI.enhancedClick(findTestObject('AI-Generated/Tracking Environment/Dynamic Objects/Page_studies_siteservice_service_site_assessments/button_siteServiceRoles', ['button_siteServiceRoles_internalHasText': data['button_siteServiceRoles_internalHasText']]))
        ...
        "Step 6: Click on button siteManagement"
    ...
    private static def execute_with_data_source(String datasource, int rowIndex) {
        ...
        Map data = [:]
        data['button_siteServiceRoles_internalHasText'] = testData.getValue('button_siteServiceRoles_internalHasText', rowIndex)
    ...
    private static def execute_without_data_source() {
        Map data = [:]
        data['button_siteServiceRoles_internalHasText'] = 'default_data'
