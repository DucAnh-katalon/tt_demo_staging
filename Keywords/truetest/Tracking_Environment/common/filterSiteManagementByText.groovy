...
public class filterSiteManagementByText {
    ...
    private static def execute_functional_method(Map data) {
        ...
        "Step 2: Click on button siteManagement"
        
        WebUI.enhancedClick(findTestObject('AI-Generated/Tracking Environment/Page_studies_dashboard/button_siteManagement'))
        
        "Step 3: Click on input textFilter3"
        
        WebUI.enhancedClick(findTestObject('AI-Generated/Tracking Environment/Page_studies_dashboard/input_textFilter3'))
        
        "Step 4: Enter input value in input textFilter3"
        
        WebUI.setText(findTestObject('AI-Generated/Tracking Environment/Page_studies_dashboard/input_textFilter3'), data['input_textFilter3'])
        
        "Step 5: Click on button apply6"
    ...
    private static def execute_with_data_source(String datasource, int rowIndex) {
        ...
        Map data = [:]
        data['input_textFilter3'] = testData.getValue('input_textFilter3', rowIndex)
    ...
    private static def execute_without_data_source() {
        Map data = [:]
        data['input_textFilter3'] = 'default_data'
