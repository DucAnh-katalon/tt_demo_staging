...
public class clickMultipleDynamicObjects {
    ...
    private static def execute_functional_method(Map data) {
        ...
        "Step 6: Click on span dynamicObject"
        
        // Bind values to the variables in the locators of "AI-Generated/Tracking Environment/Dynamic Objects/Page_env_staging_aut_history/span_dynamicObject"
        WebUI.enhancedClick(findTestObject('AI-Generated/Tracking Environment/Dynamic Objects/Page_env_staging_aut_history/span_dynamicObject', ['span_dynamicObject_spanNthChild': data['span_dynamicObject_spanNthChild_5'], 'span_dynamicObject_spanNthOfType': data['span_dynamicObject_spanNthOfType_5']]))
        
        "Step 7: Click on span dynamicObject"
        
        // Bind values to the variables in the locators of "AI-Generated/Tracking Environment/Dynamic Objects/Page_env_staging_aut_history/span_dynamicObject"
        WebUI.enhancedClick(findTestObject('AI-Generated/Tracking Environment/Dynamic Objects/Page_env_staging_aut_history/span_dynamicObject', ['span_dynamicObject_spanNthChild': data['span_dynamicObject_spanNthChild_6'], 'span_dynamicObject_spanNthOfType': data['span_dynamicObject_spanNthOfType_6']]))
        
        "Step 8: Click on span dynamicObject"
        
        // Bind values to the variables in the locators of "AI-Generated/Tracking Environment/Dynamic Objects/Page_env_staging_aut_history/span_dynamicObject"
        WebUI.enhancedClick(findTestObject('AI-Generated/Tracking Environment/Dynamic Objects/Page_env_staging_aut_history/span_dynamicObject', ['span_dynamicObject_spanNthChild': data['span_dynamicObject_spanNthChild_7'], 'span_dynamicObject_spanNthOfType': data['span_dynamicObject_spanNthOfType_7']]))
    }
    ...
    private static def execute_with_data_source(String datasource, int rowIndex) {
        ...
        data['span_dynamicObject_spanNthChild_5'] = testData.getValue('span_dynamicObject_spanNthChild_5', rowIndex)
        data['span_dynamicObject_spanNthChild_6'] = testData.getValue('span_dynamicObject_spanNthChild_6', rowIndex)
        data['span_dynamicObject_spanNthChild_7'] = testData.getValue('span_dynamicObject_spanNthChild_7', rowIndex)
        ...
        data['span_dynamicObject_spanNthOfType_5'] = testData.getValue('span_dynamicObject_spanNthOfType_5', rowIndex)
        data['span_dynamicObject_spanNthOfType_6'] = testData.getValue('span_dynamicObject_spanNthOfType_6', rowIndex)
        data['span_dynamicObject_spanNthOfType_7'] = testData.getValue('span_dynamicObject_spanNthOfType_7', rowIndex)
    ...
    private static def execute_without_data_source() {
        ...
        data['span_dynamicObject_spanNthChild_5'] = 'default_data'
        data['span_dynamicObject_spanNthChild_6'] = 'default_data'
        data['span_dynamicObject_spanNthChild_7'] = 'default_data'
        ...
        data['span_dynamicObject_spanNthOfType_5'] = 'default_data'
        data['span_dynamicObject_spanNthOfType_6'] = 'default_data'
        data['span_dynamicObject_spanNthOfType_7'] = 'default_data'
        execute_functional_method(data)
    }
